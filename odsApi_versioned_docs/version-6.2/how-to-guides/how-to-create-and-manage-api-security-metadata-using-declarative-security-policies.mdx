...
* [Ed-Fi-ODS-API-Declarative-Security-Policies.zip](https://edfidocs.blob.core.windows.net/$web/assets/reference/ods-api/Ed-Fi-ODS-API-Declarative-Security-Policies.zip)
