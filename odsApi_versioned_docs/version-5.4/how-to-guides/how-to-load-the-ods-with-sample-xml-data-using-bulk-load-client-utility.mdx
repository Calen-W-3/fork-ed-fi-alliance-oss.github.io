...
* Download and Extract [Ed-Fi-SampleDataLoad.zip](https://edfidocs.blob.core.windows.net/$web/assets/reference/ods-api/Ed-Fi-SampleDataLoad.zip) to a local folder. We recommend C:\Ed-Fi-SampleDataLoad. Ed-Fi-SampleDataLoad.zip contains all the scripts and directory structure used in this how-to article.
...
[Ed-Fi-SampleDataLoad.zip](https://edfidocs.blob.core.windows.net/$web/assets/reference/ods-api/Ed-Fi-SampleDataLoad.zip)
