...
* Download and Extract [Ed-Fi-TPDMDataLoad.zip](https://edfidocs.blob.core.windows.net/$web/assets/reference/ods-api/Ed-Fi-TPDMDataLoad.zip) to a local folder. We recommend C:\Ed-Fi-TPDMDataLoad. Ed-Fi-TPDMDataLoad.zip contains all the scripts and directory structure used in this how-to article.
...
[Ed-Fi-TPDMDataLoad.zip](https://edfidocs.blob.core.windows.net/$web/assets/reference/ods-api/Ed-Fi-TPDMDataLoad.zip)
